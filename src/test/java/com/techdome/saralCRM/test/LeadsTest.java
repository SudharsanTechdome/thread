...
//        leadsPage.uploadDocument(testData.get("document"));
//    }
...
//     Expected : The selected columns shouldn't be displayed
//     */
//    @Test(priority = 18, description = "to verify the functionalities of column by clicking cancel button")
//    public void TC_18_to_verify_the_functionalities_of_columns_by_selecting_cancel_options(){
